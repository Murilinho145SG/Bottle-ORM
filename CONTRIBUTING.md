...
[Bottle ORM Code of Conduct](CODE_OF_CONDUCT.md).
...
We use `rustfmt` for code formatting. Please ensure your code is formatted before submitting a pull request:

```bash
cargo fmt
```

We also recommend running `clippy` to catch common mistakes:
